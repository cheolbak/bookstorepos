...
public class SellBookInfoList extends JList<BookInfo> implements DataRegister<BookInfo>{
        ...
        public static class ListCellPanel extends JPanel {
            ...
            private JPanel createInfoLabelsPanel(BookInfo info) {
                ...
                if(info instanceof SellBookInfo){
                    sellPrice = ((SellBookInfo) info).getSellPrice();
                }
                else{
                    sellPrice = info.getPrice();
                }
                List<InfoLabelsPanel.Entry<JLabel>> entries = Arrays.asList(
                        ...
                        new InfoLabelsPanel.Entry<>("가격", new JLabel(numFormat.format(sellPrice)))
                );
