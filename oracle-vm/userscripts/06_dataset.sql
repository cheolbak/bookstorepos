...
INSERT INTO pos_book(pos_book_isbn, POS_BOOK_TITLE, POS_BOOK_AUTHOR, POS_BOOK_PUBLISHER,POS_BOOK_RELEASE_DATE)
VALUES ('9788968481475', '이것이 자바다', '신용권', '한빛미디어', TO_DATE('2015-01-15', 'YYYY-MM-DD'));
INSERT INTO pos_book(pos_book_isbn, POS_BOOK_TITLE, POS_BOOK_AUTHOR, POS_BOOK_PUBLISHER,POS_BOOK_RELEASE_DATE)
VALUES ('9791162241875', '혼자 공부하는 자바', '신용권', '한빛미디어', TO_DATE('2019-06-10', 'YYYY-MM-DD'));
